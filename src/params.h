...
#ifndef HARD_PARAMS_H
#define HARD_PARAMS_H
...
struct Param {
  ...
  // radius of each bead
  double sigma_bb2;
  // radius of solvent plus radius of bead
  double sigma_sb;
  double sigma_sb2;
  // diameter of each solvent particle
  double sigma_ss;
  double sigma_ss2;
  ...
  double rh;
  double rc;
  // smallest bond length squared between nonlocal neighbors
  double rh2;
  // largest bond length squared between nonlocal neighbors
  double rc2;
