...
inline std::ostream &operator<<(std::ostream &os,
                                const SolCollidesSolEvent &ev) {
  return os << "SolCollidesSolEvent{" << ev.t << ", " << ev.i << ", " << ev.j
            << ", " << ev.ni << ", " << ev.nj << "}";
}
...
using Event =
    std::variant<MinNearestEvent, MaxNearestEvent, MinNNearestEvent,
                 ...
                 MaxNonlocalOuterEvent, BeadCollidesSolEvent,
                 SolCollidesSolEvent, BeadCellEvent, SolventCellEvent>;
